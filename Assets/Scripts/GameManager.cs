...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        ui.arrow.transform.position = dices[dice].transform.position + new Vector3(0,.5f,0);
    ...
    IEnumerator Plus(int i)
    {
        ...
        while (elapsed < 0.5f)
        {
            ...
            child.transform.position = Vector3.Lerp(startPos, ui.target.transform.position, animation.Evaluate(elapsed/2));
            yield return null;
        }
